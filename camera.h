...
#define CAMERA_POSV_Y (370.0f) // カメラの視点 Y座標
#define CAMERA_POSV_Z (0.0f) // カメラの視点 Z座標

#define CAMERA_POSVY_MIN (15.0f)

#define CAMERA_POSR_X (0.0f) // カメラの注視点 X座標
#define CAMERA_POSR_Y (360.0f) // カメラの注視点 Y座標
...
#define CAMERA_DISTANCE_Y (0.0f) // 視点-注視点の距離(Y)
...
private:
	...
	D3DXVECTOR3 m_oldCameraPosV; // 前フレームのカメラ位置保存
